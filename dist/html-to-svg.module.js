...
function parseTransform (value) {
  ...
  var matrix = Transform.fromString(value);
  var _Transform$decomposeT = Transform.decomposeTSR(matrix),
  ...
  return {
    ...
    toSVGTransform: function toSVGTransform(_temp) {
      ...
      var cx = x + origin[0];
      var cy = y + origin[1];
      return Transform.toString(Transform.compose(Transform.translate((_translate$tx = translate == null ? void 0 : translate.tx) != null ? _translate$tx : 0, (_translate$ty = translate == null ? void 0 : translate.ty) != null ? _translate$ty : 0), Transform.scale((_scale$sx = scale == null ? void 0 : scale.sx) != null ? _scale$sx : 1, (_ref2 = (_scale$sy = scale == null ? void 0 : scale.sy) != null ? _scale$sy : scale == null ? void 0 : scale.sx) != null ? _ref2 : 1, cx, cy), Transform.rotate((_rotation$angle = rotation == null ? void 0 : rotation.angle) != null ? _rotation$angle : 0, cx, cy)));
    }
  };
}
  ...
  return function (element, _ref2) {
    ...
    try {
      ...
      if (!isTransparent(backgroundImage)) {
        ...
        var _ref3 = (_parseGradient$ = (_parseGradient = parse(backgroundImage)) == null ? void 0 : _parseGradient[0]) != null ? _parseGradient$ : {},
